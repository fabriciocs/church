package br.com.luasistemas.church.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "church@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "church API";

        private String description = "church API documentation";
